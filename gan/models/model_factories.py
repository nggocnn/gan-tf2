...
from gan.datasets import problem_type as pt
from gan.models.discriminators import conditional_discriminator
from gan.models.discriminators import discriminator
from gan.models.discriminators import patch_discriminator
from gan.models.gans import conditional_gan
from gan.models.gans import cycle_gan
from gan.models.gans import vanilla_gan
from gan.models.generators.image_to_image import unet
from gan.models.generators.latent_to_image import conditional_latent_to_image
...
def gan_model_factory(
    ...
    if gan_type == GANType.VANILLA.name:
        generator_optimizer = tf.keras.optimizers.Adam(
            learning_rate=input_params.learning_rate_generator, beta_1=0.5,
        )
        discriminator_optimizer = tf.keras.optimizers.Adam(
            learning_rate=input_params.learning_rate_discriminator, beta_1=0.5,
        )
...
def generator_model_factory(
    ...
    if problem_type == pt.ProblemType.VANILLA_FASHION_MNIST.name:
        ...
        return conditional_latent_to_image.LatentToImageCifar10CConditionalGenerator(input_params)
